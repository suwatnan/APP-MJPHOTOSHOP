...
class Payment3Fragment : Fragment() {
    ...
    var imgpayment4: ImageView? = null
    var file: File? = null
    var imageFilePath: String? = null
    var userID: String? = null
    var btnpay3: Button? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var root =  inflater.inflate(R.layout.fragment_payment3, container, false)
        ...
        permission()
        imgpayment4 = root.findViewById(R.id.imgpayment4)
        imageViewSlip = root.findViewById(R.id.imageViewSlip)
        imgpayment4?.setOnClickListener {
    ...
    private fun addpayment3()
    {

        var url: String = getString(R.string.root_url) + getString(R.string.AddDeposit2_url)
        Log.d("AddDeposit2",url)
    ...
    private fun viewpayment() {
        var url: String = getString(R.string.root_url) + getString(R.string.viewDeposit_url)+idbooking
