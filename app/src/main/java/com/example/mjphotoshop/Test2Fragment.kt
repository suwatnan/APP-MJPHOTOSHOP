...
class Test2Fragment : Fragment() {
    ...
    var txtpricesize: TextView? = null
    var imgformat: ImageView? = null
    var totalprice = 0.00f
    var productID = ArrayList<String>()
    var spinnerFormatprint: Spinner? = null
    ...
    private var formatprint = ArrayList<Formatprint>()
    var formatprintID = ""
    var imageFileName =""
    ...
    override fun onCreateView(
        ...
        var root =  inflater.inflate(R.layout.fragment_test2, container, false)
        ...
        txtpricesize = root.findViewById(R.id.txtpricesize)
        imgformat = root.findViewById(R.id.imgformat)
        ...
        spinnerFormatprint = root.findViewById(R.id.spinnerFormatprint)
        listFormatprint()
        ...
        spinnerSizeimage?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
                ...
                txtpricesize?.text = price +    "บาท".toString()
                showDataList(size)
        ...
        //formatprint
        val adapterFormatprint = ArrayAdapter(
                requireContext(),android.R.layout.simple_spinner_item, formatprint)
        spinnerFormatprint?.adapter = adapterFormatprint
        //spinnerProvince?.setSelection(adapterProvince.getPosition(province[0]))
        spinnerFormatprint?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
                val formatprint = spinnerFormatprint!!.selectedItem as Formatprint
                formatprintID = formatprint.formatprintID
                imageFileName = formatprint.imageFileName
                var url = getString(R.string.root_url) + getString(R.string.user_image_url)+imageFileName
                Picasso.get().load(url).into(imgformat)
    ...
    private fun addphoto()
    {
        ...
        val formBody: RequestBody = MultipartBody.Builder()
                ...
                .addFormDataPart("formatprintID", formatprintID.toString())
    ...
    internal inner class DataAdapter(private val list: List<Data>) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.txtselect.setOnClickListener {
                ...
                txtprice3?.text = (price.toFloat()  + data.price.toFloat()).toString()
                showDataList(size)
    ...
    private fun listFormatprint() {
        formatprint.add(Formatprint("0", "-เลือกรูปแบบการอัด-",""))
        val urlFormatprint: String = getString(R.string.root_url) + getString(R.string.formatprint_url)
        val okHttpClient = OkHttpClient()
        val request: Request = Request.Builder().url(urlFormatprint).get().build()
        try {
            val response = okHttpClient.newCall(request).execute()
            if (response.isSuccessful) {
                try {
                    ...
                    if (res.length() > 0) {
                        for (i in 0 until res.length()) {
                            val item: JSONObject = res.getJSONObject(i)
                            formatprint.add(Formatprint(
                                    item.getString("formatprintID"),
    ...
    internal class Formatprint(var formatprintID: String, var formatprint: String, var imageFileName: String) {
        override fun toString(): String {
    ...
    internal class Paper(var paperID: String, var papername: String) {
        override fun toString(): String {
