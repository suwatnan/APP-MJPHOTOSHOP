...
class Payment4Fragment : Fragment() {
    ...
    var imgpayment5: ImageView? = null
    var file: File? = null
    var imageFilePath: String? = null
    var userID: String? = null
    var printphotoID: String? = null
    var txtpricetotal: TextView? = null
    ...
    override fun onCreateView(
        ...
        var root =  inflater.inflate(R.layout.fragment_payment4, container, false)
        ...
        txtpricetotal = root.findViewById(R.id.txtpricetotal)
        txtpricetotal?.text = bundle?.get("price").toString() +    "บาท"
        ...
        permission()
        imgpayment5 = root.findViewById(R.id.imgpayment5)
        imageViewSlip = root.findViewById(R.id.imageViewSlip)
        imgpayment5?.setOnClickListener {
    ...
    private fun addeditpayment()
    {

        var url: String = getString(R.string.root_url) + getString(R.string.Addeditpayment_url)
        Log.d("addeditpayment",url)
    ...
    private fun viewpayment() {
        var url: String = getString(R.string.root_url) + getString(R.string.viewPayment_url)+id
        Log.d("viewDeposit",url)
        val okHttpClient = OkHttpClient()
        val request: Request = Request.Builder()
            .url(url)
            .get()
